...
tags = {
  names  = { "shell",    "browser",  "coding",   "office",   "im",
             6,          7,          8,          9 },
  layout = { layouts[4], layouts[10], layouts[3], layouts[3], layouts[6],
             layouts[6], layouts[6], layouts[7], layouts[7]}
}
for s = 1, screen.count() do
    -- Each screen has its own tag table.
...
awful.rules.rules = {
    ...
    { rule = { class = "Pithos" },        properties = { tag = tags[1][4] } },
